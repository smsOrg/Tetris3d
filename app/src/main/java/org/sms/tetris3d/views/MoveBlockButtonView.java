...
protected MovePanelAdapter rc = null;
...
public MoveBlockButtonView(Context ctx) {
        super(ctx);
...
public MoveBlockButtonView(Context ctx, AttributeSet attrs) {
        super(ctx,attrs);
        setOnTouchListener(this);
        initPaint();
        }

public MoveBlockButtonView(Context ctx, AttributeSet attrs,int themResId){
